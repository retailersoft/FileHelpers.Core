...
namespace FileHelpers
{
            ...
            IDisposable
    {
            ...
            : base(GetFirstType(recordTypes))
        {
            ...
            {
                Type recordType = recordTypes[i] ?? throw new BadUsageException("The type at index " + i + " is null.");
        ...
        public object[] ReadStream(IRecordReader reader)
        {
            ...
            using (ForwardReader freader = new(reader, mMultiRecordInfo[0].IgnoreLast))
            {
        ...
        {
            InternalStringReader reader = new(source);
...
#pragma warning restore CRRSP08 // A misspelled word has been found
        {
            ...
            ArrayList arr = new(numberOfRecords);
        ...
        private class AsyncEnumerator(MultiRecordEngine engine) : IEnumerator
        {
            private readonly MultiRecordEngine mEngine = engine;
...
#pragma warning restore CRRSP08 // A misspelled word has been found
        ...
        {
            ResetFields();
            mAsyncWriter = writer ?? throw new ArgumentException("The TextWriter can´t be null.", nameof(writer));
