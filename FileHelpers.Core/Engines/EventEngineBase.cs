...
namespace FileHelpers
{
        ...
        where T : class
    {
        ...
        {
            AfterReadEventArgs<T> e = new(this, line, lineChanged, record, lineNumber);
        ...
        {
            BeforeWriteEventArgs<T> e = new(this, record, lineNumber);
        ...
        {
            AfterWriteEventArgs<T> e = new(this, record, LineNumber, line);
